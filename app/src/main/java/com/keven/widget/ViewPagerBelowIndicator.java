 ...
 */
public class ViewPagerBelowIndicator extends LinearLayout {
    /**
     * view的宽度
     */
     ...
     * 默认字体大小
     */
    private final float DEFAULT_TEXTSIZE = Axis.scaleTextSize(30);
     ...
     * 矩形的高度
     */
    private int mTriangleHeight = 50; //指示条的高度
    ...
    public ViewPagerBelowIndicator(Context context) {
        this(context, null);
    }

    public ViewPagerBelowIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private TextView generateTextView(String text) {
        ...
        lp.width = (mWidth != -1 ? mWidth : getScreenWidth()) / mTabVisibleCount;
        tv.setGravity(Gravity.CENTER);
        tv.setTextColor(COLOR_TEXT_NORMAL);
        tv.setText(text);
        tv.setTextSize(textSize != -1f ? textSize : DEFAULT_TEXTSIZE);

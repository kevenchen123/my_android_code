...
public class WaveLineView1 extends RenderView1 {

    private static final String TAG = "WaveLineView1";

    private static final int NUM_POINTFLAKES = 7;

    public WaveLineView1(Context context) {
        this(context, null);
    }

    public WaveLineView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WaveLineView1(Context context, AttributeSet attrs, int defStyleAttr) {

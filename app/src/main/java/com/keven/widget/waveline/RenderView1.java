...
public abstract class RenderView1 extends SurfaceView implements SurfaceHolder.Callback {

    public RenderView1(Context context) {
        this(context, null);
    }

    public RenderView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RenderView1(Context context, AttributeSet attrs, int defStyleAttr) {

package com.keven.widget.waveline;
 ...
 * ================================================
 */
public class WaveLineView2 extends RenderView2 {
    ...
    private void initAttr(AttributeSet attrs) {
        TypedArray t = getContext().obtainStyledAttributes(attrs, R.styleable.WaveLineView2);
        backGroundColor = t.getColor(R.styleable.WaveLineView2_wlvBackgroundColor, Color.WHITE);
        samplingSize = t.getInt(R.styleable.WaveLineView2_wlvSamplingSize, DEFAULT_SAMPLING_SIZE);
        lineColor = t.getColor(R.styleable.WaveLineView2_wlvLineColor, Color.parseColor("#2ED184"));
        thickLineWidth = (int) t.getDimension(R.styleable.WaveLineView2_wlvThickLineWidth, 6);
        fineLineWidth = (int) t.getDimension(R.styleable.WaveLineView2_wlvFineLineWidth, 2);
        offsetSpeed = t.getFloat(R.styleable.WaveLineView2_wlvMoveSpeed, DEFAULT_OFFSET_SPEED);
        sensibility = t.getInt(R.styleable.WaveLineView2_wlvSensibility, DEFAULT_SENSIBILITY);

 ...
 * ================================================
 */
public abstract class RenderView2 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public RenderView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RenderView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private static class RenderThread extends Thread {
        ...
        private WeakReference<RenderView2> renderView;
        private boolean running = false;
        private boolean destoryed = false;
        private boolean isPause = false;

        public RenderThread(RenderView2 renderView) {
            super("RenderThread");
        ...
        private RenderView2 getRenderView() {

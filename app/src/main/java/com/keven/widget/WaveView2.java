...
public class WaveView2 extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mAmplitudeRatio = typedArray.getFloat(R.styleable.WaveView2_amplitudeRatio, DEFAULT_AMPLITUDE_RATIO);
        mWaterLevelRatio = typedArray.getFloat(R.styleable.WaveView2_waveWaterLevel, DEFAULT_WATER_LEVEL_RATIO);
        mWaveLengthRatio = typedArray.getFloat(R.styleable.WaveView2_waveLengthRatio, DEFAULT_WAVE_LENGTH_RATIO);
        mWaveShiftRatio = typedArray.getFloat(R.styleable.WaveView2_waveShiftRatio, DEFAULT_WAVE_SHIFT_RATIO);
        mFrontWaveColor = typedArray.getColor(R.styleable.WaveView2_frontWaveColor, DEFAULT_FRONT_WAVE_COLOR);
        mBehindWaveColor = typedArray.getColor(R.styleable.WaveView2_behindWaveColor, DEFAULT_BEHIND_WAVE_COLOR);
        mShapeType = typedArray.getInt(R.styleable.WaveView2_waveShape, 0) == 0 ? ShapeType.CIRCLE : ShapeType.SQUARE;
        mShowWave = typedArray.getBoolean(R.styleable.WaveView2_showWave, true);
        typedArray.recycle();
    }
    ...
    private void createShader() {
        ...
        //wave2就是wave1向左偏移1/4的wave length
                ...
                case SQUARE:
                    if (borderWidth > 0) {
                        canvas.drawRect(borderWidth / 2f, borderWidth / 2f,
                            getWidth() - borderWidth / 2f - 0.5f, getHeight() - borderWidth / 2f - 0.5f,
                            mBorderPaint);
                    }

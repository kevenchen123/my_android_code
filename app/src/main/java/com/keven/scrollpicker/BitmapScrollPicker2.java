 ...
 */
public class BitmapScrollPicker2 extends ScrollPickerView2<Bitmap> {
    ...
    public BitmapScrollPicker2(Context context) {
        this(context, null);
    }

    public BitmapScrollPicker2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BitmapScrollPicker2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            /*
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.BitmapScrollPicker);
            mDrawMode = typedArray.getInt(R.styleable.BitmapScrollPicker_spv_draw_bitmap_mode, mDrawMode);
            mSpecifiedSizeWidth = typedArray.getDimensionPixelOffset(R.styleable.BitmapScrollPicker_spv_draw_bitmap_width, mSpecifiedSizeWidth);
            mSpecifiedSizeHeight = typedArray.getDimensionPixelOffset(R.styleable.BitmapScrollPicker_spv_draw_bitmap_height, mSpecifiedSizeHeight);
